...
<head>
    ...
    <link rel="stylesheet" href="css/staff_Dashboard_Order_Online_Payment.css">
...
<body>
    ...
    <main class="mainContent" id="mainContent">
        ...
        <a href="staff_Dashboard_Orders.php"><button class="btnBack">BACK</button></a>
        <div class="form_Container">
            <div>
                <form action="php/staff_Dashboard_Orders/add_Payment_Of_Customer.php" method="post">
