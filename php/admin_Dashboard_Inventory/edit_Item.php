...
if (isset($_REQUEST['sumbitToUpdateItem'])) {
    ...
    if ($conn->query($insert_query) === TRUE) {
        ...
        header("Location: ../../admin_Dashboard_Inventory.php?msg=Edit Item Success");
    } else {
...
if (isset($_POST['submit_to_Change_Main_Image'])) {
    ...
    if ($picHasBeenUploaded == 1) {
        ...
        if ($selectQuery_Run) {
            ...
            header("Location: ../../admin_Dashboard_Inventory.php?msg=Images deleted and updated Successfully");
        } else {
            header("Location: ../../admin_Dashboard_Inventory.php?msg=Images deleted and updated Failed");
        }
    } else {
        unlink("../../img/itemPhotos/" . $change_Main_Image);

        // header("Location: ../../admin_Dashboard_Inventory.php?msg=Error : Choose a right File!");
        header("Location: ../../admin_Dashboard_Inventory.php?msg=Error : Choose a right File!");
    }
}
        ...
        ?>
            <div class="img_Container">
                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    <input type="file" name="file_Main_Image" accept=".jpg, .jpeg, .png">
                    <br>
