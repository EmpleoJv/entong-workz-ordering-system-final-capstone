...
<body>
    <main>
        ...
        <div class="main_Content">
            <h1 class="title">Payment Pending Order</h1>
            <?php
            ...
            <div class="card_Content" id="card_Content">
                ...
                <?php
                $sqlordercode = "SELECT * FROM ordercode WHERE USER_ID = '$tdbAdminId' AND PACKAGE_STATUS = 'PAYMENT PENDING' ORDER BY ID DESC";
