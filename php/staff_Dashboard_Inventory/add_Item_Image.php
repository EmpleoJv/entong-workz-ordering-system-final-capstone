    ...
    if (!empty($fileNames)) {
        ...
        if (!empty($insertValuesSQL)) {
            ...
            if ($insert > 0) {
                ...
                header("Location: ../../staff_Dashboard_Inventory.php?msg=Images are uploaded successfully." . $errorMsg);
            } else {
                // $statusMsg = "Sorry, there was an error uploading your file.";
                header("Location: ../../staff_Dashboard_Inventory.php?msg=There's an error while uploading image" . $insertValuesSQL);
            }
        } else {
            // $statusMsg = "Upload failed! " . $errorMsg;
            header("Location: ../../staff_Dashboard_Inventory.php?msg=The Error is. " . $errorMsg);
        }
    } else {
        // $statusMsg = 'Please select a file to upload.';
        header("Location: ../../staff_Dashboard_Inventory.php?msg=You didn't Upload anything");
    }
}
?>
<!DOCTYPE html>
        ...
        <div class="container">
            <div class="form_Container">
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <input type="file" name="files[]" id="files" onchange="makeFileList();" multiple accept=".jpg, .jpeg, .png">
                    <br>
            ...
            <div class="gallery_Container">
                ...
                <div class="main_Gallery">
                    <form action="../php_action/delete_Image_From_Add_Item_Image_Staff.php" method="POST">
