...
<body>
    ...
    <main class="mainContent" id="mainContent">
        ...
        if (!isset($_POST['form_submitted'])) {
            ...
            $sqlQuery = "SELECT * FROM items WHERE ITEM_STATUS = 'HIDE' AND (ITEM_NAME LIKE '%$searchQuery%' OR ITEM_CATEGORY LIKE '%$searchQuery%' OR ITEM_BRAND LIKE '%$searchQuery%');";
            // Run the SQL query
        ...
        ?>
                    <div class="card">
                        ...
                        <div class="insideContent">
                            <a href="edit_Item.php?id=<?php echo $row['ITEM_ID'] ?>"><button class="edit">EDIT</button></a>
                            <a href="../php_action/hidden_Activate_Staff.php?id=<?php echo $row['ITEM_ID'] ?>"><button class="deactivate">SHOW</button></a>
                        </div>
                        <div class="moreOptions">
                            <a href="edit_Item_Stock.php?id=<?php echo $row['ITEM_ID'] ?>"><button class="addStock">EDIT STOCK</button></a>
                            <a href="add_Item_Image.php?id=<?php echo $row['ITEM_ID'] ?>"><button class="addImage">ADD IMAGE</button></a>
                        </div>
                    </div>
                <?php
                }
