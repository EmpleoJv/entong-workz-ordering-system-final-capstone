    ...
    <main class="mainContent" id="mainContent">
        ...
        <div class="form_Container">
            <form action="#" method="POST" class="form_Update_Item_Container">
                ...
                <br>
                <input type="Number" name="ItemQuantity" placeholder="Input to add Quantity" min="1" onKeyPress="if(this.value.length==4) return false;">
                <br>
            ...
            <form action="#" method="POST" class="reset_item_Container">
                ...
                <br>
                <input type="Number" name="smallQuantity" placeholder="Update Quantity" min="1" onKeyPress="if(this.value.length==4) return false;">
                <br>
