...
if (isset($_POST['start_Update_City'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header("Location: ../../staff_Dashboard_Additem.php?msgIfUpdateSuccess=Updating Location delivery Fee : Successfully");
    } else {
        echo "Error updating record: " . $conn->error;
        header("Location: ../../staff_Dashboard_Additem.php?msgIfUpdateSuccess=Updating Location delivery Fee : Failed");
    }
}
