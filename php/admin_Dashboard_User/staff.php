...
<body>
    ...
    <main class="mainContent" id="mainContent">
        ...
        <div class="card_Content">
            ...
            <?php
            $sqlQuery = 'SELECT * FROM companylogin WHERE LEVEL = "staff" AND STATUS = "active";';
            ...
            ?>
                <div class="card">
                    ...
                    <div class="insideContent">
                        ...
                        <a href="../php_action/staff_Deactivate.php?id=<?php echo $row['ID'] ?>"><button class="deactivate">Deactivate</button></a>
                    </div>
                </div>
            <?php
            }
