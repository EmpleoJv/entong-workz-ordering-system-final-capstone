...
<head>
    ...
    <link rel="stylesheet" href="../../css/deactivated.css">
...
<body>
    ...
    <main class="mainContent" id="mainContent">
        ...
        <div class="card_Content">
            <?php
            $sqlQuery = 'SELECT * FROM companylogin WHERE STATUS = "deactivate";';
            ...
            ?>
                <div class="card">
                    ...
                    <div class="insideContent">
                        <a href="../php_action/staff_logistic_Activate.php?id=<?php echo $row['ID'] ?>"><button class="deactivate">Deactivate</button></a>
                    </div>
                </div>
            <?php
            }
