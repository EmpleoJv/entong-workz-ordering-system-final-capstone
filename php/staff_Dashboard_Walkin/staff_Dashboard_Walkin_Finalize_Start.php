    ...
    if (!empty($itemIds)) {
        ...
        if (!$insert_querys) {
            ...
            if ($conn->query($sqlsss) === TRUE) {
                ...
                header("Location: ../../staff_Dashboard_Walkin.php?finalMessage= Failed to place the order");
            } else {
        ...
        //     if ($mail->send()) {
        //         header("Location: ../../staff_Dashboard_Walkin.php?finalMessage= Success to place the order");
        //     } else {
...
<body>
    ...
    <script>
        ...
        function afterPrint() {
            ...
            window.location.href = "../../staff_Dashboard_Walkin.php";
        }
