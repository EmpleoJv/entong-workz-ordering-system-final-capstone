...
<body>
    ...
    <main class="mainContent" id="mainContent">
        ...
        <form action="admin_Dashboard_Walkin_Finalize_Start.php" method="POST">
            <div class="navTwo">
                ...
                <div class="input_Container">
                    <!-- <input type="text" maxlength="11" minlength="11" name="email" placeholder="09206709601" class="emailInput" required oninput="validatePhone(this)"> -->
    ...
    <script>
        function validatePhone(input) {
            ...
            if (phoneNumber.length === 11) {
                ...
                input.setCustomValidity('Phone number must be 11 digits long');
            }
        }
    </script>
    <script>
