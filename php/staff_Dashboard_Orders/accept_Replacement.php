...
if ($conn->query($sql) === TRUE) {
    ...
    if ($conn->query($sqls) === TRUE) {
        ...
        echo $output;
        header("Location: ../../staff_Dashboard_Orders.php?errorss= REPLACEMENT ACCEPTED Successfully");
        echo "good";
    } else {
        header("Location: ../../staff_Dashboard_Orders.php?errorss= REPLACEMENT ACCEPTED Failed");
        echo "bad";
    }
} else {
    header("Location: ../../staff_Dashboard_Orders.php?errorss= REPLACEMENT ACCEPTED Failed");
