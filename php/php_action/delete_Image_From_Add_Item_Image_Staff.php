...
if (isset($_REQUEST['start_Delete'])) {
    if (empty($_REQUEST['deleted_Checked_Id'])) {
        header("Location: ../staff_Dashboard_Inventory/hidden.php?msg=No Image Selected, Deleting Image Failed");
    }
    ...
    if ($unlinkStart->num_rows > 0) {
        ...
        header("Location: ../../staff_Dashboard_Inventory.php?msg=Images deleted Failed");
    }
    ...
    if ($query_run) {
        header("Location: ../../staff_Dashboard_Inventory.php?msg=Images deleted Successfully");
    } else {
        header("Location: ../../staff_Dashboard_Inventory.php?msg=Images deleted Failed");
    }
}
