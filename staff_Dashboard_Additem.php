...
<head>
    ...
    <link rel="stylesheet" href="css/staff_Dashboard_Additem.css">
...
<body>
    ...
    <main class="mainContent" id="mainContent">
        ...
        <div class="form_container">
            <div>
                <form action="php/php_action/staff_Dashboard_Additem_Add.php" method="POST" enctype="multipart/form-data">
            ...
            <div>
                <form action="php/php_action/staff_Dashboard_Additem_Add_Category.php">
                ...
                <form action="php/php_action/staff_Dashboard_Additem_Remove_Category.php">
                ...
                <!-- <hr> -->
                <form action="php/php_action/staff_Dashboard_AddItem_Add_Brand.php">
                ...
                <!-- <hr> -->
                <form action="php/php_action/staff_Dashboard_Additem_Remove_Brand.php">
            ...
            <div>
                <form action="php/staff_Dashboard_Inventory/update_City_Fee.php" method="post">
                    ...
                    <input type="number" name="location_Shipping_Fee" min="1" placeholder="Ex. 100" required>
                    <br>
