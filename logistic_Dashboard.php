...
<body>
    ...
    <main class="mainContent" id="mainContent">
        ...
        <div class="formContainer">
            ...
            <form action="php/php_action/logistic_Delivery_Success.php" method="get">
        ...
        <div class="allOrder" id="allOrder">
            ...
            <table id="ordersTable">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM ordercode WHERE PACKAGE_STATUS = 'ORDER ACCEPTED'";
                            ...
                            <tr class="even-row">
                                ...
                                <td>
                                    ...
                                    if (isset($user) && !empty($user)) {
                                        $sqlsss = "SELECT * FROM userlogin WHERE ID = $user";
                                        ...
                                        if ($rowsss) {
                                            ...
                                            echo "No data found for ID $idForOrderBy";
                                        }
                                    } else {
                                        echo "Not yet Accepted";
                                    }
                                ...
                                <td>
                                    <?php
                                    if (isset($acceptedBy) && !empty($acceptedBy)) {
                                        $sqlsss = "SELECT FIRSTNAME, LASTNAME FROM companylogin WHERE ID = $acceptedBy";
                                        $resultsss = $conn->query($sqlsss);
