...
<head>
    ...
    <link rel="stylesheet" href="css/staff_Dashboard_Inventory.css">
                                ...
                                <td>
                                    ...
                                    ?>
                                        <div class="action_Div">
                                            <div>
                                                <a href="php/staff_Dashboard_Inventory/edit_Item.php?id=<?php echo $row['ITEM_ID'] ?>">
                                                    <button>EDIT INFO</button>
                                                </a>
                                                <a href="php/staff_Dashboard_Inventory/edit_Item_Stock.php?id=<?php echo $row['ITEM_ID'] ?>">
                                                    <button>EDIT STOCK</button>
                                                </a>
                                            </div>
                                            <div>
                                                <a href="php/staff_Dashboard_Inventory/add_Item_Image.php?id=<?php echo $row['ITEM_ID']; ?>">
                                                    <button>ADD IMAGE</button>
                                                </a>
                                                <a href="php/php_action/hidden_Activate_Staff.php?id=<?php echo $row['ITEM_ID'] ?>">
                                    ...
                                    ?>
                                        <div class="action_Div">
                                            <div>
                                                <a href="php/php_action/showed_Deactivate_Staff.php?id=<?php echo $row['ITEM_ID'] ?>">
