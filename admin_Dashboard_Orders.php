                    ...
                    ?>
                            <tr class="even-row" data-status="<?php echo $rows['PACKAGE_STATUS']; ?>">
                                ...
                                <td>
                                    ...
                                    ?>
                                            <a href="admin_Dashboard_Order_Online_Payment.php?num=<?php echo $rows['NUMBER']; ?>&id=<?php echo $rows['CODE']; ?>&status=<?php echo $rows['PACKAGE_STATUS'] ?>&topay=<?php echo $rows['TO_PAY_ONLINE'] ?>&total=<?php echo $rows['TOTAL_PRICE'] ?>"><button class="show">VEIW PAYMENT</button></a>
                                        <?php
                                        } else if ($rows['PACKAGE_STATUS'] === "ORDER ACCEPTED") {
                                        ?>
                                            <a href="admin_Dashboard_Order_Online_Payment.php?num=<?php echo $rows['NUMBER']; ?>&id=<?php echo $rows['CODE']; ?>&status=<?php echo $rows['PACKAGE_STATUS'] ?>&topay=<?php echo $rows['TO_PAY_ONLINE'] ?>&total=<?php echo $rows['TOTAL_PRICE'] ?>"><button class="show">VEIW PAYMENT</button></a>
                                        ...
                                        ?>
                                            <a href="php/admin_Dashboard_Orders/accept_Order.php?num=<?php echo $rows['NUMBER']; ?>&action=<?php echo urlencode($rows['CODE']); ?>">
                                                <button class="acceptOrder" id="showed">ACCEPT</button>
                                            </a>
                                    <?php
                                ...
                                <td>
                                    ...
                                    $formattedDates = date('F d, Y', strtotime($orderdate));
                                ...
                                <td>
                                    <?php 
                                    $orderdatess = $rows['DELIVERY_DATE'];
                                    $formattedDatess = date('F d, Y', strtotime($orderdatess));

                                    // echo $formattedDates;
                                    
                                    echo $formattedDatess;
                                    ?>
                                </td>
                                <td>
                                    <?php
                                    // $updatedOrderDate > date('Y-m-d')
                                    $dates = new DateTime($rows['ORDER_DATE']);
                                    $dates->add(new DateInterval('P3D'));
                                    // Now $date contains the updated date with 3 days added
                                    $updatedDate = $dates->format('Y-m-d');
                                    $dateToday = date('Y-m-d');
                                    if ($rows['PACKAGE_STATUS'] === "PAYMENT PENDING") {

                                        if ($dateToday > $updatedDate) {
                                    ?>
                                            <form action="php/admin_Dashboard_Orders/admin_Buy_cancel.php" method="post" class="formms">
                                                <label for="reason">Reason For Cancelation</label>
                                                <br>
                                    ...
                                    } else if ($rows['PACKAGE_STATUS'] === "ORDER PENDING") {
                                        if ($dateToday < $updatedDate) {
                                        ?>
                                            <form action="php/admin_Dashboard_Orders/admin_Buy_cancel.php" method="post" class="formms">
                                                <label for="reason">Reason For Cancelation</label>
                ...
                <tbody>
                    ...
                    ?>
                            <tr class="even-rows" data-status="<?php echo $rows['STATUS']; ?>">
                                ...
                                <td>
                                    <?php
                                    $dast = $rows['DATE_REQUEST'] ;
                                    $formattedDateters = date('F d, Y', strtotime($dast));

                                    echo $formattedDateters;
                                    ?>
                                </td>
                                <td>
                                    <?php
                                    ...
                                    ?>
                                        <a style="display: flex; justify-content: center;" href="php/admin_Dashboard_Orders/accept_Replacement.php?num=<?php echo $rows['NUMBER']; ?>&id=<?php echo $rows['ID']; ?>&orderid=<?php echo $rows['ORDERID']; ?>&ordercode=<?php echo $rows['ORDERCODE']; ?>"><button class="pends">ACCEPT REPLACEMENT</button></a>
                                    <?php
                                    }
                                    ?>
                                </td>
