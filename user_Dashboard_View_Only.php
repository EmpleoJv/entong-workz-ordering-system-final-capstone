...
<head>
    ...
    <link rel="stylesheet" href="css/user_Dashboard_View_Only.css">
...
<body>
    <main class="main_Container">
        <nav>
            <h1>Entong Workz</h1>
            <ul>
                <li><a href="user_Dashboard.php">SIGN IN</a></li>
                <li><a href="user_Create_Account_Email.php">SIGN UP</a></li>
            </ul>
                ...
                ?>
                    <div class="card" id="cards" data-category="<?php echo $row['ITEM_CATEGORY']; ?>" data-brand="<?php echo $row['ITEM_BRAND']; ?>">
                        ...
                        <div class="actions">
                            ...
                            ?>
                                <a href="user_Create_Account_Email.php?idfromDb=<?php echo $row['ITEM_ID'] ?>"><button style="background-color: gray;" disabled>No Stocks!</button></a>
                            <?php
                            } else if ($row['ITEM_QUANTITY'] != 0) {
                            ?>
                                <a href="user_Create_Account_Email.php?idfromDb=<?php echo $row['ITEM_ID'] ?>"><button>Buy Now!</button></a>
                            <?php
                            }
                            ?>
                        </div>
