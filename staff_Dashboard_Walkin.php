...
<body>
    ...
    <main class="mainContent" id="mainContent">
        ...
        <div class="grid-container">
                        ...
                        <div class="card" id="cards" data-category="<?php echo $row['ITEM_CATEGORY']; ?>" data-brand="<?php echo $row['ITEM_BRAND']; ?>">
                            ...
                            <div class="details" id="main_Details">
                                ...
                                <div class="actions">
                                    ...
                                    <!-- <input type="number" name="itemName" id="itemId" value="<?php echo $row['ITEM_ID'] ?>">
            ...
            <div class="item2">
                <div>
                    <form action="php/staff_Dashboard_Walkin/staff_Dashboard_Walkin_Finalize.php" method="POST">
